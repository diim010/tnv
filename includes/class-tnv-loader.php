...
class TNV_Loader {
    ...
    public function add_shortcode($tag, $component, $callback) {
        $this->shortcodes = $this->add_shortcode_config($this->shortcodes, $tag, $component, $callback);
    }
     ...
     */
    private function add_shortcode_config($shortcodes, $tag, $component, $callback) {
        $shortcodes[] = array(
            'tag'           => $tag,
            'component'     => $component,
            'callback'      => $callback
